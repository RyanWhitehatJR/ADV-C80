    ...
    for (var j=1;j<=4;j++)
{
    ...
    name_of_the_student_array.push(namne_of_the_student);
}
...
for (var k = 0; k < length_of_name_of_students_array; k++)
{
    display_student_array_sorting.push("<h4>NAME - " + name_of_the_array[k] + "</h4>")
    console.log(display_student_array);
}
...
function new_update()
{
    document.getElementById("display_name_without_commas").innerHTML = "<h1>" + name_of_the_student;
}
